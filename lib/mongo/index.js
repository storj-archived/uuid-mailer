...
var Mongo = module.exports = function Mongo ( url, user, pass, ssl, sslValidate, checkServerIdentity ) {
  ...
  this.db = new Storage(url, { user, pass, mongos: { ssl, sslValidate, checkServerIdentity }}, logger);
  return this;
};
